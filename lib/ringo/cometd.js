...
function BayeuxService(name) {
    ...
    this.subscribe = function(channel, callback) {
        var channel = bayeux.getChannel(channel, true);
        // print("IS WILD? " + channel.getChannelId().isWild());
...
function unwrap(obj) {
    return (obj && obj.__javaObject__) ?
            obj.__javaObject__ : obj;
}
