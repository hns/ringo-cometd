...
var {JavaEventAdapter} = require("./cometd/event-adapter");

addToClasspath(getResource("../jars/cometd-api-1.1.1.jar"));
addToClasspath(getResource("../jars/cometd-java-server-1.1.1.jar"));
